...
export function maxLength(func: string,prop: string,len: number,value:string): void {
  if(value.length > len){
    throw new TypeError(
...
export function minLength(func: string,prop: string,len: number,value:string): void {
  if(value.length < len){
    throw new TypeError(
      `On function '${func}', property '${prop}' has an invalid length:
      \nMix length: ${len}
